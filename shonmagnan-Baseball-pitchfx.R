...
# https://github.com/shonmagnan/Baseball/blob/master/creating%20pitchfx%20database.R

if (!require(tidyverse)) install.packages('tidyverse')
if (!require(sqldf)) install.packages('sqldf')
if (!require(RHelper)) install.packages('RHelper')
if (!require(XML2R)) install.packages('XML2R')
